...
- **File System Interaction**: Custom polling mechanism or backend file watcher using Node.js

### 7.2 Backend (optional)

- Node.js script or Electron-based backend (if using desktop app)
- File system APIs for reading/writing `.md` and `.yaml` files
...
- File changes detected via polling every 3–5 seconds
- Trigger UI updates upon detection
